...
import com.docwei.okhttp.Headers.Companion.headersOf
import okio.*
...
fun Array<String>.intersect(
    other: Array<String>,
    comparator: java.util.Comparator<in String>
): Array<String> {
...
fun Array<String>.indexOf(value: String, comparator: java.util.Comparator<String>): Int =
